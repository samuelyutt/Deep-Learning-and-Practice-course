...
def getData(root, mode):
    if mode == 'train':
        img = pd.read_csv(f'{root}/train_img.csv')
        label = pd.read_csv(f'{root}/train_label.csv')
        return np.squeeze(img.values), np.squeeze(label.values)
    else:
        img = pd.read_csv(f'{root}/test_img.csv')
        label = pd.read_csv(f'{root}/test_label.csv')
        return np.squeeze(img.values), np.squeeze(label.values)
